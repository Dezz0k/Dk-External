...
namespace SkechStyle
{
	...
	{
		static const char* lockParts[]{ "Closest", "Head", "HumanoidRootPart", "UpperTorso", "LowerTorso" };
		static const char* triggerParts[]{ "Closest", "Head", "HumanoidRootPart", "UpperTorso" };
