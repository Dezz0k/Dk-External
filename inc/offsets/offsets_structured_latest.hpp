...
// Sourced from Downloads/offsets 1 (RbxDumperV2 / offsets.imtheo.lol)
...
namespace offsets {
	...
	namespace FakeDataModel {
		inline constexpr uintptr_t DataModelDeleterPointer = 0x8A5D740;
	...
	namespace LocalPlayer {
		inline constexpr uintptr_t PlayerMouse = 0x11E8;
	}
	...
	namespace MeshPart {
		...
		inline constexpr uintptr_t TextureId = 0x2D8;
	}
	...
	namespace Pointers {
		...
		inline constexpr uintptr_t TaskScheduler = 0x0;
	}
